...
export default function UpdateListing() {
  ...
  console.log("Listing ID from URL:", listingId); // Debugging log
  ...
  useEffect(() => {
    ...
    fetchListing();
  }, [listingId]); // Fetch when listingId is available
  ...
  const storeImage = async (file) => {
    ...
    formData.append('upload_preset', 'mern-estate'); // Make sure this preset exists in Cloud
